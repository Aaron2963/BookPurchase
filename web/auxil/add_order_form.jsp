  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <ul class="nav nav-tabs" id="addOrderTab" role="tablist">
          <li class="nav-item">
            <a class="nav-link active" id="input-tab" data-toggle="tab" href="#addOrderInput">建立訂單</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" id="amount-tab" data-toggle="tab" href="#addOrderAmount"">金額試算</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" id="confirm-tab" data-toggle="tab" href="#addOrderConfirm">確認訂單</a>
          </li>
        </ul>
        <div class="tab-content" id="addOrderTabContent">
          <div class="tab-pane fade show active" id="addOrderInput" role="tabpanel" aria-labelledby="input-tab">
            <div class="mt-3">
          ...
          <div class="tab-pane fade" id="addOrderAmount" role="tabpanel" aria-labelledby="amount-tab">
            <div>
              <table class="table text-center tablesorter">
                <thead class="thead">
                  <tr>
          ...
          <div class="tab-pane fade" id="addOrderConfirm" role="tabpanel" aria-labelledby="confirm-tab">
            <form id="addOrderForm" mehod="post">
...
<style type="text/css">
  ...
  #addOrderConfirm table input.form-control {
    width: 7rem;
    padding: 0;
  ...
  #addOrderConfirm table input.form-control.shipping {
    width: 4rem;
    text-align: left;
    display: inline;
    color: #000;
  }
  #addOrderConfirm table tfoot input.form-control {
    width: 8rem;
  }
</style>
